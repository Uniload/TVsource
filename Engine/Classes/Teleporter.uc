...
//	local Controller P;
	...
	if ( Pawn(Incoming) != None )
	{
		...
		{
			// DLB Controller clean pass: removed AI logic Pawn(Incoming).Controller.MoveTimer = -1.0;
			Pawn(Incoming).Anchor = self;
			// DLB Controller clean pass: removed AI logic Pawn(Incoming).SetMoveTarget(self);
		}
