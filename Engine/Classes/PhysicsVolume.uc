...
#if IG_SHARED	// rowan: turn volumes on/off
var()		bool	Active;
#endif
...
function CausePainTo(Actor Other)
{
	...
	if ( DamagePerSec > 0 )
	{
		Other.TakeDamage(int(DamagePerSec * depth), P, Location, vect(0,0,0), DamageType); 
