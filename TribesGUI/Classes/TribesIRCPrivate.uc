...
// ====================================================================
class TribesIRCPrivate extends TribesIRCChannel;
...
function PrintAwayMessage(string Nick, string Message)
{
	...
	lb_TextDisplay.AddText(MakeColorCode(IRCInfoColor)$repl(tp_System.IsAwayText, "%name%", Nick)$": "$ColorizeLinks(Message));
