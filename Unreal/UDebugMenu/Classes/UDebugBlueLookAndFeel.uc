class UDebugBlueLookAndFeel extends UWindow.UWindowLookAndFeel;

import package UWindow;

#exec LOAD FILE=UDebugMenu_res.pkg
...
{
	W.DrawClippedTexture(C, 0, 0, Texture'UDebugMenu_res.BlueMenuTL');
	W.DrawStretchedTexture(C, 2, 0, W.WinWidth-4, 2, Texture'UDebugMenu_res.BlueMenuT');
	W.DrawClippedTexture(C, W.WinWidth-2, 0, Texture'UDebugMenu_res.BlueMenuTR');

	W.DrawClippedTexture(C, 0, W.WinHeight-2, Texture'UDebugMenu_res.BlueMenuBL');
	W.DrawStretchedTexture(C, 2, W.WinHeight-2, W.WinWidth-4, 2, Texture'UDebugMenu_res.BlueMenuB');
	W.DrawClippedTexture(C, W.WinWidth-2, W.WinHeight-2, Texture'UDebugMenu_res.BlueMenuBR');

	W.DrawStretchedTexture(C, 0, 2, 2, W.WinHeight-4, Texture'UDebugMenu_res.BlueMenuL');
	W.DrawStretchedTexture(C, W.WinWidth-2, 2, 2, W.WinHeight-4, Texture'UDebugMenu_res.BlueMenuR');

	W.DrawStretchedTexture(C, 2, 2, W.WinWidth-4, W.WinHeight-4, Texture'UDebugMenu_res.BlueClientArea');
}
...
{
	W.DrawClippedTexture(C, 0, 0, Texture'UDebugMenu_res.BlueMenuTL');
	W.DrawStretchedTexture(C, 4, 0, W.WinWidth-8, 4, Texture'UDebugMenu_res.BlueMenuT');
	W.DrawClippedTexture(C, W.WinWidth-4, 0, Texture'UDebugMenu_res.BlueMenuTR');

	W.DrawClippedTexture(C, 0, W.WinHeight-4, Texture'UDebugMenu_res.BlueMenuBL');
	W.DrawStretchedTexture(C, 4, W.WinHeight-4, W.WinWidth-8, 4, Texture'UDebugMenu_res.BlueMenuB');
	W.DrawClippedTexture(C, W.WinWidth-4, W.WinHeight-4, Texture'UDebugMenu_res.BlueMenuBR');

	W.DrawStretchedTexture(C, 0, 4, 4, W.WinHeight-8, Texture'UDebugMenu_res.BlueMenuL');
	W.DrawStretchedTexture(C, W.WinWidth-4, 4, 4, W.WinHeight-8, Texture'UDebugMenu_res.BlueMenuR');

	W.DrawStretchedTexture(C, 4, 4, W.WinWidth-8, W.WinHeight-8, Texture'UDebugMenu_res.BlueMenuArea');
}
...
function ComboList_DrawItem(UWindowComboList Combo, Canvas C, float X, float Y, float W, float H, string Text, bool bSelected)
{
	...
	if(bSelected)
	{
		Combo.DrawClippedTexture(C, X, Y, Texture'UDebugMenu_res.BlueMenuHL');
		Combo.DrawStretchedTexture(C, X + 4, Y, W - 8, 16, Texture'UDebugMenu_res.BlueMenuHM');
		Combo.DrawClippedTexture(C, X + W - 4, Y, Texture'UDebugMenu_res.BlueMenuHR');
		C.SetDrawColor(0,0,0); 
	}
	else
	{
...
function ControlFrame_Draw(UWindowControlFrame W, Canvas C)
{
	...
	W.DrawStretchedTexture(C, 0, 0, W.WinWidth, W.WinHeight, Texture'UWindow_res.WhiteTexture');
...
{
	W.DrawClippedTexture(C, 0, 0, Texture'UDebugMenu_res.BlueBarL');
	W.DrawStretchedTexture( C, 16, 0, W.WinWidth - 32, 16, Texture'UDebugMenu_res.BlueBarTile');
	W.DrawClippedTexture(C, W.WinWidth - 16, 0, Texture'UDebugMenu_res.BlueBarWin');
}
...
function Menu_DrawMenuBarItem(UWindowMenuBar B, UWindowMenuBarItem I, float X, float Y, float W, float H, Canvas C)
{
	if(B.Selected == I)
	{
		B.DrawClippedTexture(C, X, 0, Texture'UDebugMenu_res.BlueBarInL');
		B.DrawClippedTexture(C, X+W-1, 0, Texture'UDebugMenu_res.BlueBarInR');
		B.DrawStretchedTexture(C, X+1, 0, W-2, 16, Texture'UDebugMenu_res.BlueBarInM');
	}
	else
	if (B.Over == I)
	{
		B.DrawClippedTexture(C, X, 0, Texture'UDebugMenu_res.BlueBarOutL');
		B.DrawClippedTexture(C, X+W-1, 0, Texture'UDebugMenu_res.BlueBarOutR');
		B.DrawStretchedTexture(C, X+1, 0, W-2, 16, Texture'UDebugMenu_res.BlueBarOutM');
	}
...
function Menu_DrawPulldownMenuItem(UWindowPulldownMenu M, UWindowPulldownMenuItem Item, Canvas C, float X, float Y, float W, float H, bool bSelected)
{
	...
	if(Item.Caption == "-")
	{
		M.DrawStretchedTexture(C, X, Y+5, W, 2, Texture'UDebugMenu_res.BlueMenuLine');
		return;
	}
	...
	if(bSelected)
	{
		M.DrawClippedTexture(C, X, Y, Texture'UDebugMenu_res.BlueMenuHL');
		M.DrawStretchedTexture(C, X + 4, Y, W - 8, 16, Texture'UDebugMenu_res.BlueMenuHM');
		M.DrawClippedTexture(C, X + W - 4, Y, Texture'UDebugMenu_res.BlueMenuHR');
	}
...
function Button_DrawSmallButton(UWindowSmallButton B, Canvas C)
{
	...
	B.DrawStretchedTextureSegment(C, 0, 0, 3, 16, 0, Y, 3, 16, Texture'UDebugMenu_res.BlueButton');
	B.DrawStretchedTextureSegment(C, B.WinWidth - 3, 0, 3, 16, 45, Y, 3, 16, Texture'UDebugMenu_res.BlueButton');
	B.DrawStretchedTextureSegment(C, 3, 0, B.WinWidth-6, 16, 3, Y, 42, 16, Texture'UDebugMenu_res.BlueButton');
}
...
defaultproperties 
{
	Active=Texture'UDebugMenu_res.BlueActiveFrame'
	Inactive=Texture'UDebugMenu_res.BlueInactiveFrame'
	ActiveS=Texture'UDebugMenu_res.BlueActiveFrameS'
	InactiveS=Texture'UDebugMenu_res.BlueInactiveFrameS'
	Misc=Texture'UDebugMenu_res.BlueMisc';
