class UDebugMapListCW extends UWindow.UWindowDialogClientWindow;
...
//	GameCombo.AddItem("Gameplay.GameInfo");
	GameCombo.AddItem("Gameplay.MultiplayerGameInfo");
	GameCombo.AddItem("Gameplay.SingleplayerGameInfo");
