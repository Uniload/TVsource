class pureCTF extends GameClasses.ModeCTF;
...
defaultproperties
{
     ...
     baseDeviceDestroyStats(0)=(statClass=Class'statdestroygenerator',baseDeviceClass=Class'BaseObjectClasses.BasePowerGenerator')
     baseDeviceDestroyStats(1)=(statClass=Class'statdestroysensor',baseDeviceClass=Class'BaseObjectClasses.BaseSensor')
     baseDeviceRepairStats(0)=(statClass=Class'statrepairgenerator',baseDeviceClass=Class'BaseObjectClasses.BasePowerGenerator')
     baseDeviceRepairStats(1)=(statClass=Class'statrepairsensor',baseDeviceClass=Class'BaseObjectClasses.BaseSensor')
     baseDeviceRepairStats(2)=(statClass=Class'statrepairinventory',baseDeviceClass=Class'BaseObjectClasses.BaseInventoryStation')
     ...
     MapListType="purectf.maplist"
     GameName="Pure Capture The Flag"
     GameDescription="Retrieve the enemy team's flag and bring it back to your team's flag stand.  Your flag must be at its stand in order to capture their flag. Points will be awarded only for flag and style related actions."
}
