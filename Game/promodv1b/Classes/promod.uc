     ...
     foreach AllActors(class'Gameplay.VehicleSpawnPoint', vehiclePad)
	    ...
	    if(EnablePod)
            ...
            if(EnableRover)
	      {
			...
			vehiclePad.vehicleClass = class'promodv1b.promodBuggy';
	      }
            else if(!EnableRover)
              {
              if (vehiclePad != None && vehiclePad.vehicleClass == class'VehicleClasses.VehicleBuggy')
...
function ModifyStats()
{
	...
	if(M != None)
	{
		...
		M.extendedProjectileDamageStats.Insert(statCount, 4);
                ...
                M.extendedProjectileDamageStats[statCount].damageTypeClass = Class'promodv1b.promodBladeProjectileDamageType';
...
function string MutateSpawnCombatRoleClass(Character c)
{
	...
	c.team().combatRoleData[2].role.default.armorClass.default.health = HOHealth;
        ...
        c.team().combatRoleData[0].role.default.armorClass.default.AllowedWeapons = class<Armor>(DynamicLoadObject("promodv1b.promodArmorLight", class'class')).default.AllowedWeapons;
	c.team().combatRoleData[1].role.default.armorClass.default.AllowedWeapons = class<Armor>(DynamicLoadObject("promodv1b.promodArmorMedium", class'class')).default.AllowedWeapons;
	c.team().combatRoleData[2].role.default.armorClass.default.AllowedWeapons = class<Armor>(DynamicLoadObject("promodv1b.promodArmorHeavy", class'class')).default.AllowedWeapons;
