...
defaultproperties
{
	...
	knockback = 10000                       // note that knockback is applied via HurtRadius instead
	knockbackAliveScale = 0 //1.0           // disabled by default for safety this close out from gold
}
