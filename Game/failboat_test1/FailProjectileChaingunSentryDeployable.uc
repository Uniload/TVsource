class FailProjectileChaingunSentryDeployable extends EquipmentClasses.ProjectileChaingunSentryDeployable;
...
singular simulated function ProjectileTouch(Actor Other, vector TouchLocation, vector TouchNormal)
{
	...
	if(Other != None && Other == Class'BaseObjectClasses.BaseSensor'){
		damageAmt = 0;
	}
