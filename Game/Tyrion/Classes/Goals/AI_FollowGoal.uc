...
class AI_FollowGoal extends AI_MovementGoal
	editinlinenew;
...
overloaded function construct( AI_Resource r, int pri, Actor _target, optional float _proximity,
							  ...
							  optional Character.GroundMovementLevels _preferredGroundMovement )
{
	priority = pri;
	target = _target;
	...
	preferredGroundMovement = _preferredGroundMovement;
