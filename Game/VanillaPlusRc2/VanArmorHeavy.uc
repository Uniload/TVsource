class VanArmorHeavy extends Gameplay.Armor;

defaultproperties
{
     AllowedWeapons(1)=(typeClass=Class'EquipmentClasses.WeaponSpinfusor',quantity=25)
     AllowedWeapons(2)=(typeClass=Class'EquipmentClasses.WeaponMortar',quantity=10)
     ...
     AllowedWeapons(7)=(typeClass=Class'EquipmentClasses.WeaponBurner',quantity=30)
