...
defaultproperties
{
     ...
     Entries(0)=(Radius=200.000000,Height=125.000000,Offset=(X=250.000000),secondaryPositions=(VP_GUNNER))
     Entries(1)=(Radius=200.000000,Height=125.000000,Offset=(Z=200.000000),primaryPosition=VP_GUNNER,secondaryPositions=(VP_DRIVER))
     ...
     goals(0)=Class'VehicleClasses.VehicleTank.AI_GunnerGuardGoal'
     abilities(0)=Class'VehicleClasses.VehicleTank.AI_VehicleExpellOccupant'
     abilities(1)=Class'VehicleClasses.VehicleTank.AI_VehicleMoveTo'
     abilities(2)=Class'VehicleClasses.VehicleTank.AI_VehiclePatrol'
     abilities(3)=Class'VehicleClasses.VehicleTank.AI_VehicleFollow'
     abilities(4)=Class'VehicleClasses.VehicleTank.AI_VehiclePursue'
     abilities(5)=Class'VehicleClasses.VehicleTank.AI_GunnerFireAt'
     abilities(6)=Class'VehicleClasses.VehicleTank.AI_GunnerGuard'
     Health=600.000000
}
