...
defaultproperties
{
     minMADistance=50
     minMAHeight=25
     FlagOutOfBounds=Class'FlagOutOfBounds'
     FlagPlay=Class'FlagPlay'
     FlagReturn=Class'FlagReturn'
     TeammateKill=Class'TeammateKill'
     FurryFlagKill=Class'FurryFlagKill'
     RabidRabbit=Class'RabidRabbit'
     ShotAngle=Class'ShotAngle'
     ShotDistance=Class'ShotDistance'
     ShotHeight=Class'ShotHeight'
     ShotSpeed=Class'ShotSpeed'
     CrazyFlag=Class'CrazyFlag'
     GoGoGadgetGrab=Class'GoGoGadgetGrab'
     GoGoGadgetSteal=Class'GoGoGadgetSteal'
     Interception=Class'Interception'
     InverseMarioGrab=Class'InverseMarioGrab'
     InverseMarioSteal=Class'InverseMarioSteal'
     KidneyThief=Class'KidneyThief'
     MarioGrab=Class'MarioGrab'
     MarioSteal=Class'MarioSteal'
     ScavengerGrab=Class'ScavengerGrab'
     ScavengerSteal=Class'ScavengerSteal'
     Turnover=Class'Turnover'
     GrabAngle=Class'GrabAngle'
     GrabDistance=Class'GrabDistance'
     GrabHeight=Class'GrabHeight'
     GrabSequence=Class'GrabSequence'
     GrabSpeed=Class'GrabSpeed'
     RandomSpawn=True
     RandomSpawnRadius=10000
     allowedMPActorList(0)=Class'TRFlag'
     ...
     baseDeviceExclusionList(6)=Class'BaseObjectClasses.BaseEnergyBarrier'
     ...
     GameDescription="Team Rabbit BETA 2"
     GameMessageClass=Class'TRGameMessage'
     Acronym="TR"
}
