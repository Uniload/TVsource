...
defaultproperties
{
     ...
     roundInfoClass=Class'ModeSTRoundInfo'
     ...
     GameName="ST"
     GameDescription="Decades of savage war have left Tribal Veterans with limited equipment. The fight rages on amongst these elite warriors."
     Acronym="ST"
}
