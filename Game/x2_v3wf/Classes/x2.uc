...
const VERSION_NAME = "x2_v3wf";
// Waking Fields EU Server version
...
var config bool DisableBaseTurrets; //Remove Base Turrets
	    ...
	    if(EnablePod)
	      {
			...
			vehiclePad.vehicleClass = class'x2_v3wf.x2Pod';
	      }
            else if(!EnablePod)
              {
              if (vehiclePad != None && vehiclePad.vehicleClass == class'VehicleClasses.VehiclePod')
            ...
            if(EnableTank)
	      {
			...
			vehiclePad.vehicleClass = class'x2_v3wf.x2Tank';
	      }
            else if(!EnableTank)
              {
              if (vehiclePad != None && vehiclePad.vehicleClass == class'VehicleClasses.VehicleTank')
