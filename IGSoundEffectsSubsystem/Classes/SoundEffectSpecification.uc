...
cpptext
{
    ...
    class USoundRef* PickSoundToPlay(INT inTextureFlags);
...
{
     SampleRate=24000
     OuterRadius=3000.000000
     Volume=100
     Pitch=1.000000
     Monoloop=(Min=-1.000000,Max=-1.000000)
     Polyloop=(PolyLoopRange=(Min=-1.000000,Max=-1.000000))
     Retriggerable=True
