...
var(GUIList) bool bNativeSort "If true, a native qSort will be used (which breaks CompareItem delegates)";
...
{
    // Not yet implemented!!!! Alphabetical compare used as placeholder!!!
    return AlphabeticalCompare( ElemA.ExtraStrData, ElemB.ExtraStrData );
}
...
#if IG_TRIBES3	// michaelj:  Integrated UT2004's FindIndex function
