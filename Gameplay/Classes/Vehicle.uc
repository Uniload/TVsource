...
defaultproperties
{
     inverseCosUprightAngle=0.600000
     ...
     minimumCollisionDamageMagnitude=100.000000
     collisionDamageMagnitudeScale=0.002500
     bCollisionDamageEnabled=True
     settledUpsideDownCosAngle=-0.100000
     settledUpsideDownSpeed=50.000000
     vehicleCameraTraceExtents=(X=60.000000,Y=60.000000,Z=60.000000)
     healthModifier=1.000000
     exits(0)=(Offset=(Y=300.000000,Z=100.000000))
     exits(1)=(Offset=(Y=-300.000000,Z=100.000000))
     clientInterpolationSnapDistance=150.000000
     clientInterpolationPeriod=0.200000
     maximumNetUpdateInterval=0.500000
     flipRotationStrength=4.000000
     flipRotationDamping=0.900000
     flipPushUpImpulse=170000.000000
     flipPushUpDuration=0.500000
     flipMaximumRotationDuration=3.000000
     TopSpeed=2000.000000
     driverMinimumPitch=-16202
     driverMaximumPitch=16202
     minimumObstacleLookAhead=600.000000
     obstacleLookAheadVeloocityScale=1.000000
     distanceToMaximumDurationScale=0.005000
     driveYawCoefficient=0.050000
     drivePitchCoefficient=0.050000
     cornerSlowDownDistance=2000.000000
     cornerSlowDownMinimumCosAngle=-0.500000
     cornerSlowDownSpeedCoefficient=10.000000
     stopForEnemies=True
     cameraDistance=1000.000000
     TPCameraLookAt=(X=100.000000,Z=100.000000)
     TPCameraDistance=600.000000
     waterDamagePerSecond=10.000000
     bCanBeStolen=True
     ...
     heavyAttemptedToPilotSwitchPromptDuration=3.000000
     initialInvincibilityDuration=6.000000
     invicibilityMaterial=Shader'FX.ScreenShader'
     velocityInheritOnExitScale=1.000000
     ShadowLightDistance=2000.000000
     MaxShadowTraceDistance=800.000000
