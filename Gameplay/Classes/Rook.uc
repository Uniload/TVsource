...
defaultproperties
{
     PeripheralVisionZAngle=0.785400
     SightRadiusToPlayer=12000.000000
     AI_LOD_ActivationDistance=6000.000000
     AI_LOD_DeactivationDistance=8000.000000
     bAIThreat=True
     shotLeadAbility=(Min=1.000000,Max=1.000000)
     shotLeadAbilityMP=(Min=1.000000,Max=1.000000)
     visionMemory=15.000000
     bUnobstructedLOF=True
     tickTimeUpdateRange=(Min=0.095000,Max=0.105000)
     ShadowLightDistance=1200.000000
     MaxShadowTraceDistance=600.000000
     bCanBeSensed=True
     bIsDetectableByEnemies=True
     radarInfoClass=Class'RadarInfo'
     teamSelfIllumSkinName="BaseLumNeutralPanner"
     grapplerRetentionScale=1.000000
