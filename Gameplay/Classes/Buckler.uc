...
defaultproperties
{
     checkingDamage=15.000000
     checkingDmgVelMultiplier=0.010000
     checkingMultiplier=300.000000
     minCheckRate=0.200000
     minCheckVelocity=800.000000
     deflectionAngle=30.000000
     projSpawnDelay=0.100000
     lostReturnDelay=3.000000
     roundsPerSecond=1.000000
     bNeedIdleFX=True
     projectileClass=Class'BucklerProjectile'
     projectileVelocity=1000.000000
     projectileInheritedVelFactor=1.000000
     aimClass=Class'AimProjectileWeapons'
     bGenerateMissSpeechEvents=False
     firstPersonMesh=SkeletalMesh'weapons.Buckler'
