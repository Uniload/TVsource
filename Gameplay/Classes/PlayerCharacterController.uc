...
defaultproperties
{
     ...
     zoomSpeed=0.750000
     maxSpectatorZoom=30.000000
     minSpectatorZoom=6.000000
     ChatWindowSizes(0)=4
     ChatWindowSizes(1)=6
     ChatWindowSizes(2)=12
     ChatWindowSizeIndex=1
     SPChatWindowSizes(0)=6
     InvExtCamOffset=(X=-200.000000,Z=210.000000)
     m_identifyFrequency=0.100000
     m_identifyRange=5000.000000
     IdentifyRadius=32.000000
     damageFlashColor=(X=900.000000)
     damageFlashScale=0.300000
     maxFlashThreshold=0.500000
     minFlashThreshold=0.100000
     damageFlashMultiplier=1.000000
     livesLeft=-1
     bUseEnabled=True
     ...
     SpectateSpeed=1200.000000
     PlayerReplicationInfoClass=Class'TribesReplicationInfo'
