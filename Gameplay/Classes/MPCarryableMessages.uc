...
defaultproperties
{
     ...
     Announcements(0)=(EffectEvent="CarryablePickedUp",DebugString="%1 carryable picked up.")
     Announcements(1)=(EffectEvent="CarryableDropped",DebugString="%1 carryable dropped.")
     Announcements(2)=(EffectEvent="CarryableReturned",DebugString="%1 carryable returned.")
}
