...
defaultproperties
{
	...
	RotationRate=(Pitch=25000,Yaw=0,Roll=0)
	...
	DrawType = DT_Mesh
	Mesh = Mesh'Weapons.BucklerProjectile'
	deathMessage = '%s copped it off %s\'s Buckler'
	
	knockback = 0       // the buckler applies knockback and damage in its bump callback instead of here
}