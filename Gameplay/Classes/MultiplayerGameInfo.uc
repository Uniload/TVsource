...
defaultproperties
{
     ...
     postGameDelay=8.000000
     tournamentCountdown=30.000000
     numTeams=2
     GameAnnouncerMessageClass=Class'MPGameAnnouncerMessages'
     GameSpyGameMode="closedwaiting"
     equipmentLifeTime=15.000000
     bPauseable=False
     bDelayedStart=True
     DefaultPlayerClassName="Gameplay.MultiplayerCharacter"
     MapListType="Gameplay.MapList"
     DeathMessageClass=Class'MPDeathMessages'
     GameMessageClass=Class'TribesGameMessage'
